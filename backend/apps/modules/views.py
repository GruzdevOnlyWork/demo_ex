...
from .models import ExamVariant, Section, Module, UserModuleProgress
...
class ExamVariantListView(generics.ListAPIView):
    queryset = ExamVariant.objects.filter(is_active=True)
    serializer_class = ExamVariantListSerializer
    permission_classes = [permissions.IsAuthenticated]


class ExamVariantDetailView(generics.RetrieveAPIView):
    queryset = ExamVariant.objects.filter(is_active=True).prefetch_related(
        'sessions__modules__steps',
        'sessions__modules__files',
        'sessions__modules__criteria'
    )
    serializer_class = ExamVariantDetailSerializer
    permission_classes = [permissions.IsAuthenticated]
