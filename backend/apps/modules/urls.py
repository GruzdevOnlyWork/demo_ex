...
from .views import (
    ...
    ExamVariantListView, ExamVariantDetailView
)
...
urlpatterns = [
    ...
    path('variants/', ExamVariantListView.as_view(), name='variant-list'),
    path('variants/<int:pk>/', ExamVariantDetailView.as_view(), name='variant-detail'),
